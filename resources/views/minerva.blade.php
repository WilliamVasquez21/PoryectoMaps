                                    ...
                                    @endif
                                        <div class="mt-3">
                                            ...
                                            @if(isset($card['fotos']))
                                                ...
                                                <p class="card-text text-card">Coordenadas de la zona: {{ $card['coordenadas'] ?? 'No coordinates available' }}</p>
                                            @else
                                                <p class="card-text text-card">{{ $card['descripcion'] ?? 'No description available' }}</p>
                                                <p class="card-text text-card">Coordenadas: {{ $card['coordenadas'] ?? 'No coordinates available' }}</p>
                                            @endif
                                        </div>
                                    </a>
                                </div>
