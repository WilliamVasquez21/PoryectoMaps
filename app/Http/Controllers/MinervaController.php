...
class MinervaController extends Controller
{
    public function index()
    {
        ...
        $referenciasResponse = Http::get('https://ues-api-production-9a53.up.railway.app/referencias');
        $aulasResponse = Http::get('https://ues-api-production-9a53.up.railway.app/aulas');
        $fotosAulasResponse = Http::get('https://ues-api-production-9a53.up.railway.app/aula_fotos');
        $fotosReferenciasResponse = Http::get('https://ues-api-production-9a53.up.railway.app/fotos_referencias');
